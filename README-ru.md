...
[История изменений](ru/changelog_ru.md) 

## Дополнительные функции

[Методы расчета расхода и их калибровочные коэффициенты](ru/fuel-methods.md)

[Расход топлива, основные принципы](ru/fuel-questions.md)
...
[Настройка главных экранов](ru/screen-settings.md)
...
[Динамические выражения: базовый синтаксис](ru/dynamic-expr-core.md)

[Спецификация формата ECUXML](ru/ecuxml_spec.md)

## Интеграция с iOS

[Автоматический запуск hobDrive при подключении к CarPlay с помощью Быстрых команд](ru/carplay-shortcut.md)
