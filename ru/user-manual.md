...
- Экраны и настройка интерфейса: [Настройка главных экранов](screen-settings.md), [Оформление, экраны и DashKits](layouts.md), [Спецификация языка разметки](LAYOUT_SPEC_RU.md), [Динамические выражения](dynamic-expr.md), [Базовый синтаксис выражений](dynamic-expr-core.md).
...
Расширенная настройка через файлы раскладок: [Оформление, экраны и DashKits](layouts.md), [Спецификация языка разметки](LAYOUT_SPEC_RU.md), [Динамические выражения](dynamic-expr.md).
...
- [Оформление, экраны и DashKits](layouts.md)
