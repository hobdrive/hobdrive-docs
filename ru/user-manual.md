...
- Экраны и настройка интерфейса: [Оформление, скины и расположение датчиков](layouts.md), [Спецификация языка разметки](LAYOUT_SPEC_RU.md), [Динамические выражения](dynamic-expr.md), [Базовый синтаксис выражений](dynamic-expr-core.md).
