...
![](images-ru/image07.unknown)Экран показывает детальную информацию по расходу топлива.
...
![](images-ru/image10.unknown)При нажатии на один из сенсоров уровня топлива откроется диалог калибровки топливного бака. При первом использовании программы необходимо ввести объем вашего бака, и (примерное) количество уже потраченного топлива.
...
![](images-ru/image16.unknown)Активные коды ошибок требуют немедленного внимания и диагностики.
...
## ![](images-ru/image26.unknown)

## Настройка внешнего вида сенсоров {#настройка-внешнего-вида-сенсоров}
...
## Калибровка параметров {#калибровка-параметров}
...
## Аппаратные требования (Windows) {#аппаратные-требования-windows}
...
## Аппаратные требования (Android) {#аппаратные-требования-android}
...
## Особенности установки и настройки {#особенности-установки-и-настройки}
